app.controller('confirmCtrl', function ($scope, $location, $rootScope, authentication) {
    $scope.dist = "";
    var drivers = [
        {
    ...
    $scope.submit = function () {
        ...
        authentication.insertRiderRequest(riderRequest).success(function () {
            ...
            alert("There are currently no drivers on shift at this time. Please try again later");
        });
    }
